...
_PINGMONITORGETRECORDREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='begin_time', full_name='PingMonitorGetRecordRequest.begin_time', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='end_time', full_name='PingMonitorGetRecordRequest.end_time', index=2,
...
_PINGMONITORGETRECORDREQUEST.fields_by_name['begin_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_PINGMONITORGETRECORDREQUEST.fields_by_name['end_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
